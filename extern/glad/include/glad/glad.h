...
typedef void(APIENTRYP PFNGLFRAMEBUFFERSAMPLEPOSITIONSFVAMDPROC)(
	GLenum target, GLuint numsamples, GLuint pixelindex,
	const GLfloat *values);
...
typedef void(APIENTRYP PFNGLLISTDRAWCOMMANDSSTATESCLIENTNVPROC)(
	GLuint list, GLuint segment, const void **indirects,
...
typedef void(APIENTRYP PFNGLMULTICASTGETQUERYOBJECTI64VNVPROC)(GLuint gpu,
							       GLuint id,
							       GLenum pname,
							       GLint64 *params);
...
typedef GLint(APIENTRYP PFNGLQUERYRESOURCENVPROC)(GLenum queryType, GLint tagId,
						  GLuint bufSize,
						  GLint *buffer);
...
typedef void(APIENTRYP PFNGLGENQUERYRESOURCETAGNVPROC)(GLsizei n,
						       GLint *tagIds);
...
typedef void(APIENTRYP PFNGLDELETEQUERYRESOURCETAGNVPROC)(GLsizei n,
							  const GLint *tagIds);
...
typedef void(APIENTRYP PFNGLQUERYRESOURCETAGNVPROC)(GLint tagId,
